...
**Control description:** Recovery from identified security incidents.

**Evidence source:** incident-response.md §4 §8 + infra/disaster-recovery.md

**Owner:** CISO

**Status:** see soc2-cc.yaml `status` field for CC7.5.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC7.5-screenshots/` 7 days before the auditor's read date.
