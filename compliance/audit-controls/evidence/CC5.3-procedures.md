...
**Control description:** Deploys controls through policies and procedures.

**Evidence source:** compliance/policies/change-management-policy.md §3

**Owner:** SRE Lead

**Status:** see soc2-cc.yaml `status` field for CC5.3.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC5.3-screenshots/` 7 days before the auditor's read date.
