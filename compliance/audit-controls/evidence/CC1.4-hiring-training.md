...
**Control description:** Attract, develop, retain competent individuals.

**Evidence source:** HR SaaS — onboarding & training attestations

**Owner:** CEO

**Status:** see soc2-cc.yaml `status` field for CC1.4.
...
- [ ] **CEO** to confirm the evidence source is current as of the audit window start.
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC1.4-screenshots/` 7 days before the auditor's read date.
