# CC3.4 — Identifies and assesses changes impacting controls

**Control description:** Identifies and assesses changes impacting controls.

**Evidence source:** compliance/policies/change-management-policy.md

**Owner:** SRE Lead

**Status:** see soc2-cc.yaml `status` field for CC3.4.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC3.4-screenshots/` 7 days before the auditor's read date.
