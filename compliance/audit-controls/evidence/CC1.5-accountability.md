# CC1.5 — Individuals held accountable for internal control

**Control description:** Individuals held accountable for internal control.

**Evidence source:** compliance/policies/security-policy.md §11 + HR disciplinary policy

**Owner:** CISO

**Status:** see soc2-cc.yaml `status` field for CC1.5.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC1.5-screenshots/` 7 days before the auditor's read date.
