...
**Control description:** Restricts transmission/movement/removal of information.

**Evidence source:** compliance/policies/security-policy.md §3 §11

**Owner:** CISO

**Status:** see soc2-cc.yaml `status` field for CC6.7.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC6.7-screenshots/` 7 days before the auditor's read date.
