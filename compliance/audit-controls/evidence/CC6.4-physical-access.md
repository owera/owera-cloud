# CC6.4 — Restricts physical access to facilities/assets

**Control description:** Restricts physical access to facilities/assets.

**Evidence source:** 1Password Owera/Compliance/physical-security/

**Owner:** SRE Lead

**Status:** see soc2-cc.yaml `status` field for CC6.4.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC6.4-screenshots/` 7 days before the auditor's read date.
