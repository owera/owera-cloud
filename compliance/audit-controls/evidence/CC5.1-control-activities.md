...
**Control description:** Selects and develops control activities.

**Evidence source:** compliance/policies/ (all seven policy docs)

**Owner:** CISO

**Status:** see soc2-cc.yaml `status` field for CC5.1.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC5.1-screenshots/` 7 days before the auditor's read date.
