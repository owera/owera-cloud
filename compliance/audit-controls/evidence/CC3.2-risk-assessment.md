...
**Control description:** Identifies and analyzes risks to objectives.

**Evidence source:** 1Password Owera/Compliance/risk-assessment-YYYY.md

**Owner:** CISO

**Status:** see soc2-cc.yaml `status` field for CC3.2.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC3.2-screenshots/` 7 days before the auditor's read date.
