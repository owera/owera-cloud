...
**Control description:** Detects and monitors configuration changes.

**Evidence source:** Git history (infra/, tunnel/, compliance/); Fly releases; Vercel deployments

**Owner:** SRE Lead

**Status:** see soc2-cc.yaml `status` field for CC7.1.
...
- [ ] If the source is out-of-tree (1Password / HR SaaS / Stripe console), capture a point-in-time screenshot and check it into `compliance/audit-controls/evidence/CC7.1-screenshots/` 7 days before the auditor's read date.
